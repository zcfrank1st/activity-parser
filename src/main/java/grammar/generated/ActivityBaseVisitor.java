...
/**
 * This class provides an empty implementation of {@link ActivityVisitor},
 ...
 */
public class ActivityBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ActivityVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitName(ActivityParser.NameContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitHost(ActivityParser.HostContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
